                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-3">Career Positions List</h4>
                                <?php
                                if (isset($_GET['msg']))
                                    echo $_GET['msg'];
                                ?>
                            ...
                            <div class="card-body">
                                <table id="careersTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody class="text-center">
                                        <?php
                                        $query = mysqli_query($con, "SELECT * FROM tblcareers ORDER BY created_at ASC");
                                        $cnt = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-info edit-btn" data-id="<?php echo $row['id']; ?>"
                                                        ...
                                                        data-roles="<?php echo htmlspecialchars($row['roles_responsibilities']); ?>"
                                                        data-skills="<?php echo htmlspecialchars($row['key_skills']); ?>"
                                                        data-status="<?php echo $row['Is_Active']; ?>">
                                                        <i class="fa fa-edit"></i>&nbsp;Edit
                                                    </button>
                                                    <a href="careerdelete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this position?')"><i class="fa fa-trash"></i>&nbsp;Delete</a>
                                                </td>
                                            </tr>
                                        <?php
                                            $cnt++;
