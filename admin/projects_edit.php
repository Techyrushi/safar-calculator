...
if (isset($_POST['update'])) {
    ...
    $query = "SELECT images FROM featured_projects WHERE id = {$aid}";
    ...
    // Update Query
    $sql = "UPDATE featured_projects
            SET title = '{$title}', heading = '{$subtitle}', paragraph = '{$content}',
                images ='{$aimage}', locations ='{$location}'
            WHERE id = {$aid}";

    $result = mysqli_query($con, $sql);

    if ($result) {
        $msg = "<p class='alert alert-success msg-box'>Featured Projects Data Updated</p>";
    } else {
        $msg = "<p class='alert alert-warning msg-box'>Featured Projects Data Not Updated</p>";
    }

    header("Location: projects_view?msg=" . urlencode($msg));
}
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Featured Projects</h3>
                            <ul class="breadcrumb">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="ulocation" value="<?php echo $row['5']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
