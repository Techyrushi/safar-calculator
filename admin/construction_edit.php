...
if (isset($_POST['update'])) {
    ...
    $query = "SELECT images FROM mahalaxmi_construction WHERE id = {$aid}";
    ...
    // Update Query
    $sql = "UPDATE mahalaxmi_construction
            SET title = '{$title}', heading = '{$subtitle}', paragraph = '{$content}',
                images ='{$aimage}', count ='{$count}'
            WHERE id = {$aid}";

    $result = mysqli_query($con, $sql);

    if ($result) {
        $msg = "<p class='alert alert-success msg-box'>Mahalaxmi Construction Data Updated</p>";
    } else {
        $msg = "<p class='alert alert-warning msg-box'>Mahalaxmi Construction Data Not Updated</p>";
    }

    header("Location: construction_view?msg=" . urlencode($msg));
}
?>
...
<head>
    ...
    <title>Mahalaxmi Construction - Vertical Form</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h3 class="page-title">Mahalaxmi Constructions</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard">Dashboard</a></li>
                                <li class="breadcrumb-item active">Mahalaxmi Constructions</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">Mahalaxmi Constructions</h2>
                            </div>
                            <?php
                            $aid = $_GET['id'];
                            ...
                            ?>
                                <form method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <h5 class="card-title">Mahalaxmi Constructions</h5>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" name="usubtitle" value="<?php echo $row['3']; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Content<span style="color: red;">*</span></label>
                                                    <div class="col-lg-9">
                                                        <textarea class="tinymce form-control" name="ucontent" rows="10" cols="30"><?php echo $row['4']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Count<span style="color: red;">*</span></label>
                                                    <div class="col-lg-9">
                                                        <input type="number" class="form-control" name="ucount" value="<?php echo $row['5']; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
