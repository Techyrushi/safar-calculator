									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><a href="feedbackedit?id=<?php echo $row['0']; ?>"><button class="btn btn-info">Edit</button></a>
													<a href="feedbackdelete?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">Delete</button></a>
												</td>
											</tr>
										<?php
											$cnt = $cnt + 1;
