...
<html lang="en">
  <head>
    ...
    <title>Safar – Pickup & Drop Services</title>
  </head>
  <body class="home">
      ...
      <main id="content" class="site-main">
        ...
        <div class="home-trip-search primary-bg">
          ...
          <div
            ...
            style="left: auto; right: 5%; transform: scaleX(-1)"
          ></div>
          <div class="container">
            ...
            <div class="destination-section">
              <div class="row">
                <div class="col-lg-4 col-md-6">
                  ...
                  >
                    <div class="destination-content">
                      ...
                      <span class="cat-link">
                        <a href="package">ITALY</a>
                      </span>
                      <h3>
                        <a href="package">SAN MIGUEL</a>
                      </h3>
                      <p>
                ...
                <div class="col-lg-4 col-md-6">
                  <article
                    class="destination-item"
                    style="background-image: url(assets/images/img2.jpg)"
                  >
                    <div class="destination-content">
                      <div class="rating-start-wrap">
                        <div class="rating-start">
                      ...
                      <span class="cat-link">
                        <a href="package">Dubai</a>
                      </span>
                      <h3>
                        <a href="package">BURJ KHALIFA</a>
                      </h3>
                      <p>
                        Fusce hic augue velit wisi ips quibusdam pariatur,
                        iusto.
                ...
                <div class="col-lg-4 col-md-6">
                  ...
                  >
                    <div class="destination-content">
                      ...
                      <span class="cat-link">
                        <a href="package">Japan</a>
                      </span>
                      <h3>
                        <a href="package">KYOTO TEMPLE</a>
                      </h3>
                      <p>
                        Fusce hic augue velit wisi ips quibusdam pariatur,
                        iusto.
              ...
              <div class="section-btn-wrap text-center">
                <a href="package" class="round-btn">More Destination</a>
              </div>
            </div>
          </div>
        </section> -->
          ...
          <div class="container">
            ...
            >
              <div class="heading-group">
                ...
                <p>
                  Fusce hic augue velit wisi quibusdam pariatur, iusto primis,
                  nec nemo, rutrum. <br />Vestibulum cumque laudantium. Sit
                  ornare mollitia tenetur, aptent.
                </p>
              </div>
              <div class="heading-btn">
                <a href="#" class="round-btn">View All Blog</a>
              </div>
            </div>
              ...
              <div class="row gx-4">
                <div class="col-lg-6">
                  <article class="post">
                    <figure
                      class="featured-post"
                      style="background-image: url(assets/images/img16.jpg)"
                    ></figure>
                    <div class="post-content">
                      ...
                      >
                        <div class="post-btn">
                          <a href="#" class="round-btn">Read More</a>
                        </div>
                ...
                <div class="col-lg-6">
                  <article class="post">
                    ...
                    <div class="post-content">
                      ...
                      <h3>
                        <a href="#">BTRAVEL WITH FRIENDS IS BEST</a>
                      </h3>
                      <p>
                        Laboris hac erat dolor, posuere volutpat fringilla
                        gravida metus nonummy, blandit mi...
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-4 text-md-end">
                <a href="contact" class="outline-btn outline-btn-white"
                  >Contact Us !</a
                >
              </div>
            </div>
