...
<html lang="en">
   <head>
      ...
      <title>404 | Traveler – Travel & Trip Business HTML5 Template</title>
   </head>
   <body>
                        ...
                        <div class="col-lg-8 offset-lg-2">
                           <div class="no-content-wrap">
                              ...
                              <div class="search-form-wrap">
                                 <form method="get" class="no-content-form">
                                    <input type="email" name="email" placeholder="Enter your email...">
                                    <button class="round-btn">sign up</button>
                                 </form>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                           <aside class="widget widget_text">
                              <div class="footer-logo">
                                 <a href="index"><img src="assets/images/site-logo.png" alt=""></a>
                              </div>
                              ...
                              <ul>
                                 <li>
                                    <figure class="post-thumb">
                                       <a href="blog-archive"><img src="assets/images/img21.jpg" alt=""></a>
                                    </figure>
                                    <div class="post-content">
                                       <h6>
                                          <a href="blog-single">BEST JOURNEY TO PEACEFUL PLACES</a>
                                       </h6>
                                       <div class="entry-meta">
                                          <span class="posted-on">
                                             <a href="blog-archive">February 17, 2022</a>
                                          </span>
                                       </div>
                                    </div>
                                 </li>
                                 <li>
                                    <figure class="post-thumb">
                                       <a href="blog-archive"><img src="assets/images/img22.jpg" alt=""></a>
                                    </figure>
                                    <div class="post-content">
                                       <h6>
                                          <a href="blog-single">TRAVEL WITH FRIENDS IS BEST</a>
                                       </h6>
                                       <div class="entry-meta">
                                          <span class="posted-on">
                                             <a href="blog-archive">February 17, 2022</a>
                        ...
                        <div class="col-lg-6 text-right">
                           ...
                           <div class="footer-menu">
                              <ul>
                                 ...
                                 <li>
                                    <a href="policy">Term & Condition</a>
                                 </li>
                                 <li>
                                    <a href="faq">FAQ</a>
                                 </li>
